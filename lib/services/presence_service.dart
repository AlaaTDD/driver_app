...
class PresenceService {
  ...
  PresenceService({MessagesRepository? repo}) : _repo = repo ?? MessagesRepository();
  ...
  void onSync(Function(Map<String, bool> onlineMap, Map<String, bool> typingMap) callback) {
    if (_channel != null) {
