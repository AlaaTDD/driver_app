...
/// A three-segment tab control for trip status filtering.
///
/// Previously duplicated as:
/// - `SegmentedControl` in user/trips/widgets/segmented_control.dart
/// - `_SegmentedControl` inline in driver/trips/driver_trips_screen.dart
class SharedSegmentedControl extends StatelessWidget {
